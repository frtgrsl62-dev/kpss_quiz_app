...
# ===============================
# Kullanıcıya ait sonuçları kaydet
# ===============================
...
def soru_goster_page():
    ...
    if cevap_key not in st.session_state:
        st.session_state[cevap_key] = None

    secim = st.radio("Cevap Seçin:", options=secenekler, index=-1, key=f"soru_radio_{index}")
